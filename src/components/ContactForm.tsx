        ...
        <div className='bg-slate-700 rounded w-screen-md p-3 flex justify-center box-border mt-16'>
            ...
            <form className="max-w-md  mt-16">
                ...
                <div className='mt-8'>
                    ...
                    <button onClick={() => navigate("/contacts")} className="text-white float-left bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-700 dark:hover:bg-gray-800 dark:focus:ring-gray-800">Cancel</button>
